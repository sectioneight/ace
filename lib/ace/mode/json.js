 ...
 *      Aiden Scandella <aiden.scandella AT socrata DOT com>
 *
...
var Mode = function() {
    this.$tokenizer = new Tokenizer(new JsonHighlightRules().getRules());
...
(function() {
    ...
    this.createWorker = function(session) {
        ...
        worker.on("jsonlint", function(results) {
            session.setAnnotations([results.data])
        });
        
        worker.on("jsonlintclean", function() {
